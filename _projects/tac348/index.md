...
description: This semester-long project in AME 485 involved comprehensive finite element analysis (FEA) of aerospace and mechanical components using ANSYS. I built detailed geometries and developed models with both solid and shell elements, carefully generating meshes for each and selecting appropriate element types, mesh densities, and solver settings to balance accuracy and computational efficiency. I also created custom material definitions to represent advanced aerospace materials accurately.
